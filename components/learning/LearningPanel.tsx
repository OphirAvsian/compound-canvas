...
export function LearningPanel({
  ...
  return (
    <aside className="h-full bg-[#fffefa] p-5 xl:border-l xl:border-[#deddd7]">
      ...
      {conformer ? (
        <>
          <p className="mt-6 text-[12px] font-bold uppercase tracking-[0.15em] text-[#3c896b]">
            Calculated result
          </p>
          <h2 className="mt-2 text-[19px] font-semibold tracking-[-0.03em]">
            A real 3D starting shape
          </h2>
          <p className="mt-3 text-[14px] leading-7 text-[#62707c]">
          ...
          <div className="mt-4 rounded-xl border border-[#cfe8dc] bg-[#eff9f3] p-4">
            <p className="text-[13px] font-semibold text-[#24684e]">Canonical SMILES</p>
            <code className="mt-2 block break-all text-[12px] leading-5 text-[#315b4b]">
              {conformer.canonical_smiles}
            </code>
          </div>
          <p className="mt-4 text-[13px] leading-5 text-[#7a858d]">
          ...
          <div className="mt-5 rounded-xl border border-[#e2e2dc] bg-white p-4">
            <p className="text-[13px] font-semibold">Try this observation</p>
        ...
        <>
          ...
          <div className="mt-5 rounded-xl border border-[#dce7e1] bg-[#f3f8f5] p-4">
            <p className="text-[13px] font-semibold text-[#35634f]">What to notice</p>
            <p className="mt-2 text-[13px] leading-5 text-[#68776f]">
      ...
      <div className="mt-6 rounded-xl bg-[#f2f1ed] p-4">
        ...
        <p className="mt-2 text-[13px] leading-5 text-[#717c76]">
          Molecule creation, conformer generation, and the separate 2ITY protein viewer
          use real coordinates. Compound Canvas now includes one curated EGFR docking
          estimate lesson; arbitrary docking and interaction detection are not implemented.
        </p>
      </div>
    </aside>
  );
