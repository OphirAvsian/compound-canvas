          ...
          <>
            ...
            <div className="mt-4 rounded-2xl border border-[#d8d7d1] bg-white p-4">
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#eef7f2] px-3 py-1.5 text-[9px] font-semibold text-[#356d54]">
              ...
              {!lessonComplete && (
                <button
                  ...
                  className="mt-4 inline-flex items-center justify-center gap-1.5 rounded-xl border border-[#cfd8d3] bg-[#f6faf8] px-3 py-2.5 text-[10px] font-semibold text-[#38664f]"
                >
