      ...
      <div className="mx-auto max-w-[1180px]">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="max-w-2xl">
            <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#806225]">Mission 5 - Receptor cleanup</p>
          ...
          <div className="flex gap-2">
            ...
            <span className="rounded-full bg-[#fff4de] px-3 py-1.5 text-[9px] font-semibold text-[#77591f]">Not docking-ready</span>
          </div>
        </div>
